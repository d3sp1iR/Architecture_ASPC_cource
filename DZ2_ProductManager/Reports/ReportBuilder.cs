...
namespace DZ2_ProductManager.Reports
{
    /// <summary>
    ...
    class ReportBuilder
    {
        ...
        /// <summary>
        /// Включает нумерацию строк (группа А)
        /// </summary>
        ...
        /// <summary>
        /// Добавляет итоговую строку внизу отчёта (группа В)
        /// </summary>
        ...
        /// <summary>
        /// Выполняет запрос и возвращает отформатированную строку отчёта
        /// </summary>
        public string Build()
        {
        ...
        /// <summary>
        /// Сохраняет отчёт в текстовый файл (группа Б)
        /// </summary>
